...
import fr.theflogat.gearbox.tome.buttons.ButtonChangePage;
...
public class GuiTomeTemplate extends GuiScreen{
	...
	private static final ResourceLocation page = new ResourceLocation(ModLib.ModId.toLowerCase(), "textures/gui/nextPrevious.png");
	...
	public GuiTomeTemplate(String id) {
		background = new ResourceLocation(ModLib.ModId.toLowerCase(), "textures/gui/tomeBack" + id + ".png");
		buttons = new ResourceLocation(ModLib.ModId.toLowerCase(), "textures/gui/tomeButtons" + id + ".png");
